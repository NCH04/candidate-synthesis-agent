...
# Prepend the frontmatter. Guard against a source README that already has one.
if head -1 README.md | grep -q '^---$'; then
    die "README.md on '$SOURCE_BRANCH' already starts with frontmatter — remove it there"
fi
